...
#define CanTrcv_4711_PCA82C250_GetBusWuReason(CanNetwork, Reason)           MyCanTrcv_PublicIf.CanTrcv_GetBusWuReason(CanNetwork, \
                                                                                                                      Reason)
#define CanTrcv_4711_PCA82C250_GetVersionInfo(Versioninfo)                  MyCanTrcv_PublicIf.CanTrcv_GetVersionInfo(Versioninfo)
#define CanTrcv_4711_PCA82C250_SetWakeupMode(TrcvWakeupMode, CanNetwork)    MyCanTrcv_PublicIf.CanTrcv_SetWakeupMode(TrcvWakeupMode, \
                                                                                                                     CanNetwork)
