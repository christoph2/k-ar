...
#include "Port.h"
    ...
    #error Wrong Version-Information of Include-File 'Port.h' !
#endif
...
#define PORT_NUMBER_OF_PORT_PINS /* todo: Den Wert aus 'S12_Mebi' verwenden !? */
...
FUNC(void,PORT_CODE) Port_Init(P2CONST(Port_ConfigType,AUTOMATIC,PORT_APPL_DATA) ConfigPtr)
{
    ...
    S12Mebi_Init(Port_ConfigurationPtr);
}
